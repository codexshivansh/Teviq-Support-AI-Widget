(function () {
  ...
  function mountWidget() {
    ...
    const button = createElement("button", "teviq-chat-button", "AI");
    button.type = "button";
    button.setAttribute("aria-label", "Open support chat");

    const windowEl = createElement("section", "teviq-chat-window");
    windowEl.setAttribute("aria-label", `${brandName} support chat`);

    const header = createElement("header", "teviq-chat-header");
    const brandWrap = createElement("div", "teviq-chat-brand");
    const avatar = createElement("div", "teviq-chat-avatar", "T");
    const titleWrap = createElement("div", "teviq-chat-title-wrap");
    const title = createElement("h2", "teviq-chat-title", brandName);
    ...
    appendMessage(
      messages,
      "bot",
      `Hi, welcome to ${brandName} support. How can I help?`
    );
